...
![Tecnologias](https://skillicons.dev/icons?i=js,ts,nodejs,mysql,postgresql,vscode,git,github&theme=dark)

## Sobre mim:

- 👋 Olá, meu nome é Heitor Fonseca e eu sou Desenvolvedor Backend.
- 🧠 Meu objetivo é me tornar um desenvolvedor FullStack.
- 👨‍💻 Minhas principais stacks são Typescript, Node.js com Express, Node.js com Nest.js, SQL, PostgreSQL, Redis.
- 💬 Se você curte jogos e tecnologias, fale comigo!!!
